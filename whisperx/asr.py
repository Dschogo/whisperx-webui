...
class FasterWhisperPipeline(Pipeline):
    ...
    def transcribe(
        ...
        #for idx, out in tqdm.tqdm(enumerate(self.__call__(data(audio, vad_segments), batch_size=batch_size, num_workers=num_workers)), total=len(vad_segments), desc="Transcribing"):
        with tqdm.tqdm(
            total=len(vad_segments), unit="segments", desc="Transcribing"
        ) as pbar:
